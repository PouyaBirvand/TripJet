        ...
        <div className="flex flex-col items-center justify-center px-4 sm:px-8 pt-14 sm:pt-16 pb-8 sm:pb-10">
          ...
          <div className="flex items-center justify-center gap-2 sm:gap-3 w-full max-w-md">
            <button
              ...
              className="btn btn-outline btn-error rounded-lg font-normal bg-red-500 text-white shadow-none w-1/2 max-w-xs text-xs sm:text-sm py-2 sm:py-2.5 h-auto min-h-0"
            >
              خروج
            </button>
            <button
              onClick={onClose}
              className="btn btn-[#14324] btn-error rounded-lg font-normal bg-white shadow-none w-1/2 max-w-xs text-xs sm:text-sm py-2 sm:py-2.5 h-auto min-h-0"
            >
              انصراف
            </button>
          </div>
