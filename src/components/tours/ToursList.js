      ...
      <div className="p-8 text-center flex flex-col justify-center items-center mt-15">
        ...
        <div className="flex items-center justify-center mt-4">
          <p className="text-gray-600 text-lg">
            متأسفانه برای مبدا تهران به مقصد مالزی توری یافت نشد!
          </p>
        </div>
        <Link
          href="/"
          className=" text-nowrap  mt-6 inline-block bg-blue-500 text-white py-2 px-4 rounded-lg md:w-1/2 w-full duration-150 transition-all hover:bg-blue-600"
        >
          بازگشت به صفحه اصلی
        </Link>
      </div>
