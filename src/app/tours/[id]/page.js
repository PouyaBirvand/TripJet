      ...
      <div className="max-w-2xl w-full bg-white rounded-2xl shadow-lg overflow-hidden">
        ...
        <div className="p-6">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-amber-700 text-sm">
                  صفحه جزئیات تور با شناسه{' '}
                  <span className="font-mono bg-amber-100 px-1.5 py-0.5 rounded text-amber-800">
                    {params.id}
                  </span>{' '}
                  در حال ساخت است و به زودی در دسترس قرار خواهد گرفت.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  در این صفحه می‌توانید جزئیات کامل تور، تصاویر، برنامه سفر، قیمت و امکان رزرو را
                  مشاهده کنید.
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Link
              href="/"
              className="btn bg-blue-600 rounded-lg text-white py-5 flex items-center justify-center gap-2"
            >
            ...
            <Link
              href="/tours"
              className="btn btn-outline hover:bg-blue-600 hover:text-white rounded-lg text-blue-600 py-5  flex items-center justify-center gap-2"
            >
              مشاهده سایر تورها
            </Link>
          </div>
